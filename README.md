...
Требуется, чтобы директория существовала и в ней можно создавать файлы. 

Для остановки работы программы сервера достаточно нажать комбинацию клавиш Ctrl+C.
